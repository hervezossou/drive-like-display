...
export const ContentCard = ({ item, layout } : ContentCardProps) => {
  ...
  const cardClasses = layout === "grid" 
    ...
    : "flex flex-row items-center p-4 border-b rounded-br-lg border-gray-200 bg-white hover:bg-blue-50 transition-colors";
  ...
  return (
    <div className={cardClasses}>
      ...
      <div className={layout === "grid" ? "text-left" : "flex-1"}>
